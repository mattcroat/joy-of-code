...
I was used to the constant iframe flashing on each update when using [Codepen](https://codepen.io/) but when I was playing around in the [Svelte REPL](https://svelte.dev/repl/hello-world) I noticed it doesn't do that — in fact it updates **instantly** without the iframe flashing.
