...
published: '2021-3-28'
category: 'CSS'
image: '/images/css-focus-outline/flowers.webp'
---

<Image src="/images/css-focus-outline/flowers.webp" alt="Flowers" gif={true} />
...
You might be tempted to remove focus styles. There's only one problem. **It's terrible for accessibility**. [Focus outline](https://developer.mozilla.org/en-US/docs/Web/CSS/:focus) provides visual feedback for users who can't use a mouse, or have visual impairment using <kbd>Tab</kbd> on their keyboard for navigation.
...
Accessibility is important. It's a large subject worth understanding. No one goes out of their way to create a bad user experience on purpose. If you're aware, and strive to make the web a better place — that's what counts.
