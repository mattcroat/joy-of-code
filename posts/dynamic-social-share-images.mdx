...
<Image
  height={381}
  width={447}
  src="/images/dynamic-social-share-images/social-card.webp"
  alt="Social card embed"
  inline={true}
/>

In this post I'm going to show you a simple way how to automate that process, so that you're able to **art direct** and **quickly export** one for your post using what you already know as a developer without involving a **headless browser** and **serverless**.
...
<Image
  height={778}
  width={1177}
  src="/images/dynamic-social-share-images/social-share.webp"
  alt="Project end result"
/>
...
You can deploy this to anywhere like [Netlify](https://www.netlify.com/) by simply pointing to your repository since it's just a **static site** and you're not using a server.
