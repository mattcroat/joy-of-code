...
Most color picking sites aren't helpful because they give you five random colors you have no idea what to do with. You only need to find a **primary** color you like and from there you can find **complementary** colors that work with together. If you're using **black** and **white** you're already using two colors.
