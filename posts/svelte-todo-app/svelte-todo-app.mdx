...
🖌️ Remove these things because we don't need them:
...
```html:src/components/Todos.svelte {4,14-39,46,48,84} {showLineNumbers}
<script lang="ts">
  import type { ITodo } from '$root/types/todo'
...
```html:src/components/Todos.svelte {5,42-49,61} {showLineNumbers}
<script lang="ts">
  import type { ITodo } from '$root/types/todo'
...
```html:src/components/Todos.svelte {51-53,65} {showLineNumbers}
<script lang="ts">
  import type { ITodo } from '$root/types/todo'
...
```html:src/components/Todos.svelte {55-58,70} {showLineNumbers}
<script lang="ts">
  import type { ITodo } from '$root/types/todo'
...
```html:src/components/Todos.svelte {6,18,77} {showLineNumbers}
<script lang="ts">
  import type { ITodo } from '$root/types/todo'
...
```html:src/components/Todos.svelte {2,7,17,22,66-79,90,97} {showLineNumbers}
<script lang="ts">
...
```html:src/components/Todos.svelte {8,24,83-85,104} {showLineNumbers}
<script lang="ts">
  import type { FiltersType, ITodo } from '$root/types/todo'
...
```html:src/components/Todos.svelte {2,16,67-73,100-106} {showLineNumbers}
<script lang="ts">
...
Keep an eye on the next post where I'm going to show you how to add tests. 🧪
