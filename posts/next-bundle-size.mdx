...
description: How to swap React for Preact to reduce Next.js bundle size
published: '2021-9-1'
category: 'next'
image: '/images/next-bundle-size/og-image.webp'
---
...
<Image
  height={648}
  width={1000}
  src="/images/next-bundle-size/react.webp"
  alt="Next.js bundle size using React"
/>
...
This might sound like a lot of work, but it only requires two steps using **Next.js**. Credits go to [Lee Robinson](https://leerob.io/).
...
<Image
  height={648}
  width={1000}
  src="/images/next-bundle-size/preact.webp"
  alt="Next.js bundle size using Preact"
/>
