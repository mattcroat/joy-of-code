...
If we go back and look at **lib.es5.d.ts** on the right it looks like something we would expect. You can double-click it or <kbd>Alt</kbd> + <kbd>Click</kbd> the **type definition** to open it.
