...
I find most explanations confusing because they spend time explaining features instead of showing you how to use the feature. That's why if possible, I encourage you to follow along.
...
Your terminal and editor should indicate you're on the right branch:
...
If the branch is remote you have to remove it from GitHub.
