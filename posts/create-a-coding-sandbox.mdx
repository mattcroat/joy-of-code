...
Have you wondered how code editors such as [Codepen](https://codepen.io/), [JSFiddle](https://jsfiddle.net/), or [CodeSandbox](https://codesandbox.io/) work? So have I! Let me extend a personal invitation to code along 😄
...
[JavaScript Sandbox](https://javascriptsandbox.netlify.app/) to see the working example. You can find the [source code](https://github.com/mattcroat/javascript-sandbox) on GitHub.
