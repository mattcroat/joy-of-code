...
Regardless of your knowledge, and experience. This might seem contrived, but say we don't know anything about the DOM (Document Object Model). The DOM might be a metaphor for something else. You might not even known how to select the element itself. Are we just stuck? No, we're just going to watch a course that's going to teach us everything, even if you don't have to know everything. I'm joking! 😂
