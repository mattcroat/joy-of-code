...
description: Remove client-side JavaScript in production on a per-page basis
published: '2021-9-4'
category: 'next'
...
Keep in mind this is **experimental** and **only works in production**, so if you're in **development** everything might seem to work but remember it won't work in **production**.
