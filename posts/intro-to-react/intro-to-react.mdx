---
title: Introduction to React and Frameworks
description: Introduction to React that answers why should you learn a framework
slug: 'intro-to-react'
published: '2021-2-13'
category: 'react'
image: '/images/intro-to-react/social-image.webp'
---
